    ...
    <div class="container">
        ...
        <div class="row clearfix">
            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>@lang('site.update_product')</h2>
                    </div>
                    <div class="body"style="min-height: 197px;">
                        <form method="POST" action="{{route('update_product_store',$products->id)}}" enctype='multipart/form-data'>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea class="form-control" name="content_ar"  cols="30" rows="10" placeholder="@lang('site.content_ar')">{{$products->content_ar}}</textarea>
                                    @error('content_ar')
                                    <h6 class='alert alert-danger'>{{$message}}</h6>
                                   @enderror
                                </div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea class="form-control" name="content_en"  cols="30" rows="10" placeholder="@lang('site.content_en')">{{$products->content_en}}</textarea>
                                    @error('content_en')
                                    <h6 class='alert alert-danger'>{{$message}}</h6>
                                   @enderror
                                </div>
                                ...
                                <div class="form-line">
                                    ...
                                    <select id="subcategory_id" name="subcategory_id" class="form-control">
                                        @foreach ($supcategories as $supcategory)
                                         @if (App::getLocale() == 'ar')
                                        <option value="{{$supcategory->id}}">{{$supcategory->name_ar}}</option>
                                         @else
                                        <option value="{{$supcategory->id}}">{{$supcategory->name_en}}</option>
                                         @endif
                                        @endforeach
                                    </select>   
                                </div>

        ...
        <div class="container">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>@lang('site.update_subcategory')</h2>
                        </div>
                        <div class="body"style="min-height: 197px;">
                            <form method="POST" action="{{route('update_subcategory_store',$subcategories->id)}}">
                                @csrf
